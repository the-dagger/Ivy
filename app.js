...
var accountSid = 'AC6eb49ff502986a6f5ceb5fa0e159ef0a';
var authToken = '38481f6c2a62d987f5d83ff6f881e8f5';
...
app.post ( '/api/message', function (req, res) {
  ...
  conversation.message ( payload, function (err, data) {
    ...
    if ( logs ) {
      ...
      if(data.entities.length > 0 && data.entities[0].entity == "city") {
          console.log("City found");
        client.messages.create({
  to: "+17185514482",
  from: "+19179246693",
  body: "Todays Forecast by Ivy",
  ...
  console.log(message.sid);
    ...
    if (data.entities.length > 0 && data.entities[0].entity == "stocks") {
    client.messages.create({
  to: "+17185514482",
  from: "+19179246693",
  body: "Todays Stocks by Ivy",
  mediaUrl: "https://qph.ec.quoracdn.net/main-qimg-7db37367afcd58631565ad3dd50e2748?convert_to_webp=true", 
}, function(err, message) {
  console.log(message.sid);
});
      }  
      
    if (data.entities.length > 0 && data.entities[0].entity == "sports") {
    client.messages.create({
  to: "+17185514482",
  from: "+19179246693",
  body: "Todays Sports by Ivy",
  mediaUrl: "http://time-static-shared.s3-website-us-east-1.amazonaws.com/interactives/ncaa_football_2015/screenshot.png", 
}, function(err, message) {
  console.log(message.sid);
});
      }
          if (data.entities.length > 0 && data.entities[0].entity == "movies") {
    client.messages.create({
  to: "+17185514482",
  from: "+19179246693",
  body: "Popular Movie by Ivy",
  mediaUrl: "http://vignette1.wikia.nocookie.net/marvelcinematicuniverse/images/5/5c/Civil_War_Final_Poster.jpg/revision/latest?cb=20160310172110", 
}, function(err, message) {
  console.log(message.sid);
});
      }
